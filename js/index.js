...
let timerTimeOut
const card1Audio = new Audio ('https://github.com/Paru369/focus-timer/blob/main/sounds/Floresta.wav?raw=true')
const card2Audio = new Audio('https://github.com/Paru369/focus-timer/blob/main/sounds/Chuva.wav?raw=true')
const card3Audio = new Audio('https://github.com/Paru369/focus-timer/blob/main/sounds/Cafeteria.wav?raw=true')
const card4Audio = new Audio('https://github.com/Paru369/focus-timer/blob/main/sounds/Lareira.wav?raw=true')
...
function music() {
  if (buttonCard1.classList.contains('active')) {
    card1Audio.play()
  } else {
    card1Audio.pause()
    } 
  if (buttonCard2.classList.contains('active')) {
    card2Audio.play()
  } else {
    card2Audio.pause()
  }
  if (buttonCard3.classList.contains('active')) {
    card3Audio.play()
  } else {
    card3Audio.pause()
  }
  if (buttonCard4.classList.contains('active')) {
    card4Audio.play()
  } else {
    card4Audio.pause()
  }
